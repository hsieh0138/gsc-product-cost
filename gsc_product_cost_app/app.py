...
if not st.session_state.authenticated:
    ...
    # 自訂匯率
    exchange_rate = st.number_input("🌊 請輸入自訂匯率 (TWD 轉 USD)", min_value=1.0, value=32.0, step=0.1)
    ...
    for _, row in edited_df.iterrows():
        if row["產品名稱 Product"]:
            ...
            results.append({
                ...
                "建議售價商品售價 (TWD)": suggested_price,
                "建議售價商品售價 (USD)": usd_price,
            })
